...
- (BOOL)textFieldShouldReturn:(UITextField *)textField
{
    if([textField isEqual: textFld_])
    {
        ...
        {
            NSDictionary *dic = [NSDictionary dictionaryWithObjectsAndKeys:[NSNumber numberWithInt:self.tag - 600], @"tag", textField.text, @"text", nil];
...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        lblText_ = [[UILabel alloc] initWithFrame:CGRectMake(15, 10, 260, 24)];
        [lblText_ setBackgroundColor:[UIColor clearColor]];
        ...
        checkImg_ = [[UIImageView alloc] initWithFrame:CGRectMake(270, 10, 25, 25)];
